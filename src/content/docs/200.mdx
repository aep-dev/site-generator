...
If an API violates "<b class="text-yellow-700">should</b>" or "<b class="text-yellow-700">should not</b>" AEP guidance for any
reason, there <b class="text-red-700">must</b> be an internal comment linking to this document using
...
<Aside type="caution" title="Important">
  APIs <b class="text-red-700">must not</b> violate guidance specified with "<b class="text-red-700">must</b>" or
  "<b class="text-red-700">must not</b>", even with a link to this AEP. Tools such as documentation
  generators and client generators <b class="text-green-700">may</b> assume full compliance with "<b class="text-red-700">must</b>"
  and "<b class="text-red-700">must not</b>" guidance.
</Aside>
...
before the deadline. In those cases, API review councils <b class="text-green-700">may</b> grant
