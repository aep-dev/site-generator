...
In order to ensure that these issues are not forgotten, they <b class="text-yellow-700">should</b> be
...
beta version, there <b class="text-red-700">must</b> be an internal comment linking to this document
using its descriptive link ([aep.dev/beta-blocker]()) to ensure that the design
is corrected before the API is released to beta.

The comment <b class="text-red-700">must</b> also indicate what kind of change should be made for beta.
For example:
