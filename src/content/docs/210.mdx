...
<Aside type="tip" title="undefined">
  Unique identifiers **should** limit to ASCII, generally only
...
<Aside type="tip" title="undefined">
  Unicode values **should** be stored in [Normalization Form C][].
</Aside>
...
<Aside type="tip" title="undefined">
  Unicode values **must** be normalized to [Normalization Form C][]
