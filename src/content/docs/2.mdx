...
- A merged AEP <b class="text-red-700">must</b> use the next available number.
- AEPs <b class="text-red-700">must</b> be numbered between 1 and 9999.

### Organization-specific AEPs

- Organizations <b class="text-green-700">may</b> extend the AEPs with guidance that is relevant to them.
- Organization-specific AEPs <b class="text-red-700">must</b> use AEP numbers 10000 or greater.
...
- The category of an AEP <b class="text-green-700">may</b> change over time.
...
- The slug of an AEP <b class="text-green-700">may</b> change over time, sometimes to refer to a new
